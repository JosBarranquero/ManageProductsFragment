...
public class DatabaseContract {
    ...
    public static class ProductEntry implements BaseColumns {
        ...
        public static final String PRODUCT_JOIN_CATEGORY = String.format("%s INNER JOIN %s ON %s=%s.%s",
                TABLE_NAME, DatabaseContract.CategoryEntry.TABLE_NAME, COLUMN_IDCATEGORY, DatabaseContract.CategoryEntry.TABLE_NAME, BaseColumns._ID);
        public static final String[] COLUMNS_PRODUCT_JOIN_CATEGORY = {
                TABLE_NAME + "." + COLUMN_NAME, COLUMN_DESCRIPTION, DatabaseContract.CategoryEntry.TABLE_NAME + "." + DatabaseContract.CategoryEntry.COLUMN_NAME
        };
        ...
        public static final String REFERENCE_ID_CATEGORY = String.format("REFERENCES %s (%s) ON UPDATE CASCADE ON DELETE RESTRICT", DatabaseContract.CategoryEntry.TABLE_NAME, BaseColumns._ID);
    ...
    public static class InvoiceEntry implements BaseColumns {
        ...
        public static final String REFERENCE_STATUS = String.format("REFERENCES %s (%s) ON UPDATE CASCADE ON DELETE RESTRICT", DatabaseContract.InvoiceStatusEntry.TABLE_NAME, BaseColumns._ID);
        public static final String SQL_CREATE_ENTRIES = String.format("CREATE TABLE %s (%s INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," +
                        "%s INTEGER NOT NULL %s," +
                        "%s TEXT NOT NULL," +
                        "%s INTEGER NOT NULL %s)",
    ...
    public static class InvoiceLineEntry implements BaseColumns {
        ...
        public static final String COLUMN_PRICE = "price";
        public static final String REFERENCE_ID_INVOICE = String.format("REFERENCES %s (%s) ON UPDATE CASCADE ON DELETE RESTRICT", DatabaseContract.InvoiceEntry.TABLE_NAME, BaseColumns._ID);
